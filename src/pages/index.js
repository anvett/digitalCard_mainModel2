  ...
  const items = [
    {
      ...
      year: "2018",
      description:
        "Graduada en la UDLA, con el título de Arquitecta, con conocimientos en el área de diseño y estructuras",
      logo: "/images/education/udla_logo.jpg",
    },
  ];
        ...
        <Container fluid className={styles.mainContainer}>
            ...
            <Col xs={12} className={styles.infoCol}>
              ...
              <section>
                <PersonalInfo
                  name="Eva Doe"
                  title="Arquitecta"
                  description="Arquitecta especializada en diseño de estructuras"
          ...
          <Row>
            <Col className={styles.videoPlayer}>
              <VideoPlayer videoUrl="/video/users/mantenimiento_industrial.mp4" />
            </Col>
          </Row>
